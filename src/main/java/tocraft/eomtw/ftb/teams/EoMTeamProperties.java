...
public class EoMTeamProperties {
    public static final PrivacyToIdMapProperty DESTROY_BLOCKS_BLACKLIST = new PrivacyToIdMapProperty(EoMTweaks.id("destroy_blocks_blacklist"), new HashMap<>());
    public static final PrivacyToIdMapProperty DESTROY_BLOCKS_WHITELIST = new PrivacyToIdMapProperty(EoMTweaks.id("destroy_blocks_whitelist"), new HashMap<>());
